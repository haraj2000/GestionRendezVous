...
public class AppointementService extends AbstractFacade<Appointement>{
    ...
    public int createAppointement(String reference, Date dateAppointement, Date hourAppointement, TypeAppointement typeAppointement, Patient patient, Doctor doctor){
        Appointement appointementFounded = find(reference);
        if(appointementFounded== null){
            appointementFounded= new Appointement(reference, dateAppointement, hourAppointement, typeAppointement, patient, doctor);
